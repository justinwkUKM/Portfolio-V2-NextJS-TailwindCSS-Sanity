    ...
    return (
        ...
        duration-200 overflow-hidden'>
            ...
            <div className='px-0 md:px-10 flex flex-col justify-center items-center'>
                <h4 className='text-2xl xl:text-4xl text-gray-700 dark:text-gray-100 font-bold py-1 mt-2'>{experience.jobTitle}</h4>
                <h4 className='text-xl xl:text-2xl text-gray-700 dark:text-gray-100 font-semibold py-1'>{experience.company}</h4>
