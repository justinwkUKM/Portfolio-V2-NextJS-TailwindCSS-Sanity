...
export default function Skills({skills }: Props) {
    return (
        ...
        mx-auto items-center'>
            <h3 className='absolute top-24 uppercase tracking-[20px] text-gray-500 md:text-2xl'>Skills</h3>
            <h3 className='absolute mt-2 top-36 text-gray-500 text-xs '>Hover over a skill to know more</h3>
