        ...
        if (currentTheme === 'dark') {
            return (
                <button className='hover:scale-110' onClick={() => setTheme('light')}>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6 text-gray-500 hover:text-orange-300  animate-wiggle">
            ...
            return (
                <button className='hover:scale-110'  onClick={() => setTheme('dark')}>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6 text-gray-500 hover:text-yellow-600  animate-wiggle">
