...
export default function Experience({ experiences }: Props) {
    ...
    return (
        ...
        >
            <h3 className='absolute top-24 uppercase tracking-[20px] text-gray-500  md:text-2xl z-20'>Work Experience</h3>
            <h3 className='absolute mt-2  top-36 text-gray-500 text-xs z-20'>Swipe for more</h3>
