...
export default function Experience({ experiences }: Props) {
    ...
    return (
        ...
        >
            ...
            <div className='w-full h-full mt-40 flex space-x-5 overflow-hidden overflow-x-scroll snap-x snap-mandatory scrollbar-track-gray-600 scrollbar-thumb-orange-600 scrollbar-thin z-0'>
                {
